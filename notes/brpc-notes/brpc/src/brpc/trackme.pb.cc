...
void protobuf_AssignDesc_brpc_2ftrackme_2eproto() {
  ...
  TrackMeRequest_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TrackMeRequest, _unknown_fields_),
      -1,
  ...
  TrackMeResponse_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TrackMeResponse, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
...
TrackMeRequest* TrackMeRequest::New() const {
...
::google::protobuf::uint8* TrackMeRequest::SerializeWithCachedSizesToArray(
...
void TrackMeRequest::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const TrackMeRequest* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const TrackMeRequest*>(
      &from);
  if (source == NULL) {
...
TrackMeResponse* TrackMeResponse::New() const {
...
::google::protobuf::uint8* TrackMeResponse::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
void TrackMeResponse::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const TrackMeResponse* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const TrackMeResponse*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
