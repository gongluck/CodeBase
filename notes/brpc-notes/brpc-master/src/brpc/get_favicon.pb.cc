...
void protobuf_AssignDesc_brpc_2fget_5ffavicon_2eproto() {
  ...
  GetFaviconRequest_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(GetFaviconRequest, _unknown_fields_),
      -1,
  ...
  GetFaviconResponse_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(GetFaviconResponse, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
...
GetFaviconRequest* GetFaviconRequest::New() const {
...
::google::protobuf::uint8* GetFaviconRequest::SerializeWithCachedSizesToArray(
...
void GetFaviconRequest::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const GetFaviconRequest* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const GetFaviconRequest*>(
      &from);
  if (source == NULL) {
...
GetFaviconResponse* GetFaviconResponse::New() const {
...
::google::protobuf::uint8* GetFaviconResponse::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
void GetFaviconResponse::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const GetFaviconResponse* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const GetFaviconResponse*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
